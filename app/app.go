...
import (
	...
	"github.com/puneet166/qie/encoding"
	"github.com/puneet166/qie/x/evm/core/vm"

	// unnamed import of statik for swagger UI support
	_ "github.com/puneet166/qie/client/docs/statik"
	"github.com/puneet166/qie/utils"

	qietypes "github.com/puneet166/qie/types"
	"github.com/puneet166/qie/x/epochs"
	epochskeeper "github.com/puneet166/qie/x/epochs/keeper"
	epochstypes "github.com/puneet166/qie/x/epochs/types"
	"github.com/puneet166/qie/x/evm"
	evmkeeper "github.com/puneet166/qie/x/evm/keeper"
	evmtypes "github.com/puneet166/qie/x/evm/types"
	inflation "github.com/puneet166/qie/x/inflation/v1"
	inflationkeeper "github.com/puneet166/qie/x/inflation/v1/keeper"
	inflationtypes "github.com/puneet166/qie/x/inflation/v1/types"

	"github.com/puneet166/qie/app/ante"
	ethante "github.com/puneet166/qie/app/ante/evm"
	"github.com/puneet166/qie/app/post"
	v20 "github.com/puneet166/qie/app/upgrades/v20"
	srvflags "github.com/puneet166/qie/server/flags"
	"github.com/puneet166/qie/x/erc20"
	erc20keeper "github.com/puneet166/qie/x/erc20/keeper"
	erc20types "github.com/puneet166/qie/x/erc20/types"
	"github.com/puneet166/qie/x/feemarket"
	feemarketkeeper "github.com/puneet166/qie/x/feemarket/keeper"
	feemarkettypes "github.com/puneet166/qie/x/feemarket/types"
	"github.com/puneet166/qie/x/staking"
	stakingkeeper "github.com/puneet166/qie/x/staking/keeper"
	"github.com/puneet166/qie/x/vesting"
	vestingkeeper "github.com/puneet166/qie/x/vesting/keeper"
	vestingtypes "github.com/puneet166/qie/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/puneet166/qie/x/ibc/transfer"
	transferkeeper "github.com/puneet166/qie/x/ibc/transfer/keeper"

	memiavlstore "github.com/crypto-org-chain/cronos/store"

	// Force-load the tracer engines to trigger registration due to Go-Ethereum v1.10.15 changes
	_ "github.com/puneet166/qie/x/evm/core/tracers/js"
	_ "github.com/puneet166/qie/x/evm/core/tracers/native"
)
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".qied")

	// manually update the power reduction by replacing micro (u) -> atto (a) qie
	sdk.DefaultPowerReduction = qietypes.PowerReduction
...
var (
	_ servertypes.Application = (*Qie)(nil)
	_ ibctesting.TestingApp   = (*Qie)(nil)
	_ runtime.AppI            = (*Qie)(nil)
)

// Qie implements an extended ABCI application. It is an application
...
func (*Qie) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}

// NewQie returns a reference to a new initialized Ethermint application.
func NewQie(
	logger log.Logger,
	db dbm.DB,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		qietypes.ProtoAccount, maccPerms,
...
func (app *Qie) Name() string { return app.BaseApp.Name() }

func (app *Qie) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: qietypes.HasDynamicFeeExtensionOption,
...
func (app *Qie) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.mm.BeginBlock(ctx)
}

// EndBlocker updates every end block
func (app *Qie) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.mm.EndBlock(ctx)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Qie) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	defer func() {
...
func (app *Qie) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
	var genesisState qietypes.GenesisState
...
func (app *Qie) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.mm.PreBlock(ctx)
}

// LoadHeight loads state at a particular height
func (app *Qie) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Qie) ModuleAccountAddrs() map[string]bool {
...
//   - the static precompiled contracts available through qie
func (app *Qie) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Qie's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Qie) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Qie's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Qie) AppCodec() codec.Codec {
	return app.appCodec
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *Qie) DefaultGenesis() qietypes.GenesisState {
	return app.BasicModuleManager.DefaultGenesis(app.appCodec)
}

// InterfaceRegistry returns Qie's InterfaceRegistry
func (app *Qie) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Qie) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Qie) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Qie) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Qie) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Qie) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Qie) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Qie) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Qie) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *Qie) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Qie) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Qie) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Qie) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Qie) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Qie) GetTxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *Qie) AutoCliOpts() autocli.AppOptions {
...
func (app *Qie) setupUpgradeHandlers() {
	// v20 upgrade handler
