...
import (
	...
	"github.com/puneet166/qie/ethereum/eip712"
	"github.com/puneet166/qie/wallets/accounts"
	"github.com/puneet166/qie/wallets/usbwallet"
)
...
func QieLedgerDerivation() Secp256k1DerivationFn {
	qieSECP256K1 := new(QieSECP256K1)

	return func() (sdkledger.SECP256K1, error) {
		return qieSECP256K1.connectToLedgerApp()
	}
}

var _ sdkledger.SECP256K1 = &QieSECP256K1{}

// QieSECP256K1 defines a wrapper of the Ethereum App to
// for compatibility with Cosmos SDK chains.
type QieSECP256K1 struct {
	*usbwallet.Hub
...
func (e QieSECP256K1) Close() error {
...
func (e QieSECP256K1) GetPublicKeySECP256K1(hdPath []uint32) ([]byte, error) {
	if e.PrimaryWallet == nil {
...
// GetAddressPubKeySECP256K1 takes in the HD path as well as a "Human Readable Prefix" (HRP, e.g. "qie")
// to return the public key bytes in secp256k1 format as well as the account address.
func (e QieSECP256K1) GetAddressPubKeySECP256K1(hdPath []uint32, hrp string) ([]byte, string, error) {
	if e.PrimaryWallet == nil {
...
func (e QieSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte, _ byte) ([]byte, error) {
...
func (e QieSECP256K1) displayEIP712Hash(typedData apitypes.TypedData) error {
...
func (e *QieSECP256K1) connectToLedgerApp() (sdkledger.SECP256K1, error) {
