...
import (
	...
	"github.com/puneet166/qie/wallets/ledger/mocks"
...
func (suite *LedgerTestSuite) SetupTest() {
	...
	suite.ledger = ledger.QieSECP256K1{Hub: hub, PrimaryWallet: mockWallet}
}
	...
	tmp := whitespaceRegex.ReplaceAllString(
		`{
			...
			"msgs":[{
				...
				"value":{
					"amount":[{"amount":"150","denom":"atom"}],
					"from_address":"qie10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky",
					"to_address":"qie1fx944mzagwdhx0wz7k9tfztc8g3lkfk6rrgv6l"
				}
			}],
			"sequence":"6"
		}`,
...
func (suite *LedgerTestSuite) getMockTxProtobuf() []byte {
	...
	msg := bankTypes.NewMsgSend(
		sdk.MustAccAddressFromBech32("qie10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky"),
		sdk.MustAccAddressFromBech32("qie1fx944mzagwdhx0wz7k9tfztc8g3lkfk6rrgv6l"),
		[]sdk.Coin{
			{
				Denom:  "atom",
