...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "qie_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "QIE_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Qie_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "qie_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "qie_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "qie_qie_1990-1", true, nil,
		},
		{
			"invalid epoch, undefined", "qie_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "qie_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
