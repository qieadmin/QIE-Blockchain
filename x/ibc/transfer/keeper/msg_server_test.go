...
import (
	...
	"github.com/puneet166/qie/x/ibc/transfer/keeper"
	...
	testCases := []struct {
	...
	}{
		{
			...
			func() *types.MsgTransfer {
				transferMsg := types.NewMsgTransfer("transfer", "channel-0", sdk.NewCoin("aqie", math.NewInt(10)), sender.AccAddr.String(), "", timeoutHeight, 0, "")
				return transferMsg
			},
			true,
		},
