...
import (
	...
	qiecore "github.com/puneet166/qie/x/evm/core/core"
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		CanTransfer: qiecore.CanTransfer,
		Transfer:    qiecore.Transfer,
		GetHash:     k.GetHashFn(ctx),
		Coinbase:    cfg.CoinBase,
		GasLimit:    qietypes.BlockGasLimit(ctx),
	...
	txCtx := qiecore.NewEVMTxContext(msg)
	if tracer == nil {
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := qietypes.SafeInt64(height)
		if err != nil {
