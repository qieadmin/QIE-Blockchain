...
func init() {
	proto.RegisterType((*V3GenesisState)(nil), "qie.erc20.v1.V3GenesisState")
	proto.RegisterType((*V3Params)(nil), "qie.erc20.v1.V3Params")
}

func init() { proto.RegisterFile("qie/erc20/v1/genesis.proto", fileDescriptor_2f4674601b0d6987) }
