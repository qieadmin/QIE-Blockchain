...
const (
	// Amino names
	convertERC20Name = "qie/MsgConvertERC20"
	convertCoinName  = "qie/MsgConvertCoin" // keep it for backwards compatibility when querying txs
	updateParams     = "qie/erc20/MsgUpdateParams"
	registerERC20    = "qie/erc20/MsgRegisterERC20"
	toggleConversion = "qie/erc20/MsgToggleConversion"
)
