...
import (
	...
	"github.com/puneet166/qie/testutil/integration/common/factory"
	qiefactory "github.com/puneet166/qie/testutil/integration/qie/factory"
	...
	"github.com/puneet166/qie/x/vesting/types"
...
//
// Example:
// 21/10 Employee joins Qie and vesting starts
...
var _ = Describe("Clawback Vesting Account - Smart contract", func() {
	...
	BeforeEach(func() {
		...
		contractAddr, err = s.factory.DeployContract(
			...
			evmtypes.EvmTxArgs{},
			qiefactory.ContractDeploymentData{
				Contract:        contract,
