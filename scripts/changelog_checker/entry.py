...
def check_link(link: str, pr_number: int) -> Tuple[str, List[str]]:
    ...
    if not link.startswith("https://github.com/puneet166/qie/pull/"):
        fixed = f"https://github.com/puneet166/qie/pull/{pr_number}"
        problems.append(f'PR link should point to qie repository: "{link}"')
