...
import (
	...
	"github.com/puneet166/qie/tests/integration/ledger/mocks"
	...
	clientkeys "github.com/puneet166/qie/client/keys"
	qiekeyring "github.com/puneet166/qie/crypto/keyring"
...
func (suite *LedgerTestSuite) SetupQieApp() {
...
func (suite *LedgerTestSuite) qieAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = qiekeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = qiekeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = qiekeyring.CreatePubkey
		options.LedgerAppName = qiekeyring.AppName
		options.LedgerSigSkipDERConv = qiekeyring.SkipDERConversion
	}
}
