...
// TestQieVersionsLess tests the QieVersions type's Less method with
// different version strings
func TestQieVersionsLess(t *testing.T) {
	var version QieVersions
...
// TestQieVersionsSwap tests the QieVersions type's Swap method
func TestQieVersionsSwap(t *testing.T) {
	var version QieVersions
	value := "v9.1.0"
...
// TestQieVersionsLen tests the QieVersions type's Len method
func TestQieVersionsLen(t *testing.T) {
	var version QieVersions = []string{"v9.1.0", "v10.0.0"}
