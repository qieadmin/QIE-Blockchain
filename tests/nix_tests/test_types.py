...
def test_block(qie_cluster, geth):
    # Perform block queries (eth_getBlockByNumber & eth_getBlockByHash)
    # on qie and geth nodes, and compare the responses
    # Case 1: block without transactions
    get_blocks(qie_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(qie_cluster, geth, True)


def get_blocks(qie_rpc_ws, geth, with_transactions):
    w3: Web3 = qie_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    qie_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [qie_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(eth_rpc, geth_rpc, "eth_accounts", [])


def test_syncing(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(qie_cluster, geth):
    # on qie the proof query will fail for block numbers <= 2
...
def test_get_code(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(qie_cluster, geth):
    w3: Web3 = qie_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(qie_cluster, geth):
...
def test_incomplete_send_transaction(qie_cluster, geth):
