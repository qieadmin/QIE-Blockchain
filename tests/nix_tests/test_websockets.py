def test_single_request_netversion(qie_cluster):
    qie_cluster.use_websocket()
    eth_ws = qie_cluster.w3.provider
...
def test_batch_request_netversion(qie):
    return


def test_ws_subscribe_log(qie):
    return


def test_ws_subscribe_newheads(qie):
    return
