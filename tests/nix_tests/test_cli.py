...
def test_block_cmd(qie_cluster):
    """
    - start 2 qie nodes
    ...
    node1 = qie_cluster.cosmos_cli(1)
...
def test_tx_flags(qie_cluster):
    ...
    test_cases = [
        {
            ...
            "flags": {"fees": "5000000000aqie", "gas_prices": "50000aqie"},
            "exp_err": True,
        ...
        },
        {
            ...
            "flags": {"fees": "10aqie", "gas": 50000, "gas_prices": None},
            "exp_err": True,
            "err_msg": "insufficient fee",
        },
        {
            "name": "fail - insufficient gas",
            "flags": {"fees": "500000000000aqie", "gas": 1, "gas_prices": None},
            "exp_err": True,
            "err_msg": "out of gas",
        },
        {
        ...
        },
        {
            ...
            "flags": {"gas_prices": "100000000000aqie", "gas": 1500000},
            "exp_err": False,
            "err_msg": None,
        },
        {
    ...
    for tc in test_cases:
        try:
            res = node.transfer(
                "signer1",
                "qie10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky",
                "100000000000000aqie",
                False,
                **tc["flags"],
            )
