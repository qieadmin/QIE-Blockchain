...
import (
	...
	cmnfactory "github.com/puneet166/qie/testutil/integration/common/factory"
...
func (s *PrecompileTestSuite) setupVestingAccount(funder, vestAcc testkeyring.Key) *vestingtypes.ClawbackVestingAccount {
	...
	fundMsg := vestingtypes.NewMsgFundVestingAccount(
		...
		vestAcc.AccAddr,
		vestingStart,
		qieutil.TestVestingSchedule.LockupPeriods,
		qieutil.TestVestingSchedule.VestingPeriods,
	)
