...
import (
	...
	teststypes "github.com/puneet166/qie/types/tests"
)

func init() {
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("qie", "qiepub")
}
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1",
				Receiver: "qie1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Amount:   "123456",
			},
			expSender:    "",
			expRecipient: "",
		...
		{
			name: "valid - cosmos sender, qie recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Receiver: "qie1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Amount:   "123456",
			},
			expSender:    "qie1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expRecipient: "qie1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expError:     false,
		},
		{
			name: "valid - qie sender, cosmos recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "qie1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Receiver: "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Amount:   "123456",
			},
			expSender:    "qie1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expRecipient: "qie1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expError:     false,
		},
		{
			name: "valid - osmosis sender, qie recipient",
			data: transfertypes.FungibleTokenPacketData{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/aqie",
			"10",
			sdk.Coin{Denom: "aqie", Amount: math.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped aqie coin",
			"aqie",
			"10",
			sdk.Coin{Denom: "aqie", Amount: math.NewInt(10)},
		},
		{
			"get ibc wrapped aqie coin",
			"transfer/channel-0/aqie",
			"10",
			sdk.Coin{Denom: teststypes.aqieIbcdenom, Amount: math.NewInt(10)},
		},
		{
...
func TestDeriveDecimalsFromDenom(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expDec:    0,
			expFail:   true,
			expErrMsg: "Should be either micro ('u[...]') or atto ('a[...]'); got: \"nqie\"",
		},
		{
