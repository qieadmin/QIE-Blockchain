...
import (
	...
	_ "github.com/puneet166/qie/server/config/migration" // Add this import to set up the proper app.toml migration logic for sdk v0.50
)
...
const (
	...
	DefaultRosettaDenomToSuggest = "aqie"
...
func AppConfig(denom string) (string, interface{}) {
	...
	//
	// In qie, we set the min gas prices to 0.
	if denom != "" {
