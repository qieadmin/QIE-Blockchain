...
import (
	...
	cryptocodec "github.com/puneet166/qie/crypto/codec"
	enccodec "github.com/puneet166/qie/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("qie", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, qietypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, qietypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(qietypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Qie implementation
	...
	// Equality of Eth and Qie implementation
	...
	// Inequality of wrong derivation path of Eth and Qie implementation
