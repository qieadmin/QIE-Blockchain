...
import (
	...
	"github.com/puneet166/qie/wallets/ledger"
)

// AppName defines the Ledger app used for signing. Qie uses the Ethereum app
const AppName = "Ethereum"

var (
	// SupportedAlgorithms defines the list of signing algorithms used on Qie:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Qie for the Ledger device:
	...
	// LedgerDerivation defines the Qie Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.QieLedgerDerivation()
