...
WORKDIR /go/src/github.com/puneet166/qie
...
COPY --from=build-env /go/src/github.com/puneet166/qie/build/qied /usr/bin/qied
...
RUN apk add --no-cache \
    ...
    rclone \
    && addgroup -g 1000 qie \
    && adduser -S -h /home/qie -D qie -u 1000 -G qie
