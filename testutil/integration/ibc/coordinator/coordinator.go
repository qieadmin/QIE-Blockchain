...
import (
	...
	qieibc "github.com/puneet166/qie/ibc/testing"
	"github.com/puneet166/qie/testutil/integration/common/network"
	ibcchain "github.com/puneet166/qie/testutil/integration/ibc/chain"
)
...
type Coordinator interface {
	...
	GetPath(a, b string) *qieibc.Path
...
// GetPath returns the transfer path for the chain ids 'a' and 'b'
func (c *IntegrationCoordinator) GetPath(a, b string) *qieibc.Path {
	chainA := c.coord.GetChain(a)
	chainB := c.coord.GetChain(b)

	return qieibc.NewTransferPath(chainA, chainB)
}
