...
import (
	...
	infltypes "github.com/puneet166/qie/x/inflation/v1/types"

	evmtypes "github.com/puneet166/qie/x/evm/types"
)

// genSetupFn is the type for the module genesis setup functions
type genSetupFn func(qieApp *app.Qie, genesisState qietypes.GenesisState, customGenesis interface{}) (qietypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *app.Qie, genesisState qietypes.GenesisState, _ interface{}) (qietypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(qieApp *app.Qie, genesisState qietypes.GenesisState, customGenesis interface{}) (qietypes.GenesisState, error) {
		moduleGenesis, ok := customGenesis.(T)
		if !ok {
			return nil, fmt.Errorf("invalid type %T for %s module genesis state", customGenesis, moduleName)
		}

		genesisState[moduleName] = qieApp.AppCodec().MustMarshalJSON(moduleGenesis)
		return genesisState, nil
	}
}
...
// createQieApp creates an qie app
func createQieApp(chainID string, customBaseAppOptions ...func(*baseapp.BaseApp)) *app.Qie {
	// Create qie app
	db := dbm.NewMemDB()
...
func setDefaultStakingGenesisState(qieApp *app.Qie, genesisState qietypes.GenesisState, overwriteParams StakingCustomGenesisState) qietypes.GenesisState {
	// Set staking params
	...
	genesisState[stakingtypes.ModuleName] = qieApp.AppCodec().MustMarshalJSON(stakingGenesis)
	return genesisState
}
...
func setDefaultBankGenesisState(qieApp *app.Qie, genesisState qietypes.GenesisState, overwriteParams BankCustomGenesisState) qietypes.GenesisState {
	...
	genesisState[banktypes.ModuleName] = qieApp.AppCodec().MustMarshalJSON(bankGenesis)
	return genesisState
}
...
func setDefaultSlashingGenesisState(qieApp *app.Qie, genesisState qietypes.GenesisState, overwriteParams SlashingCustomGenesisState) qietypes.GenesisState {
	...
	genesisState[slashingtypes.ModuleName] = qieApp.AppCodec().MustMarshalJSON(slashingGen)
	return genesisState
}

// setBankGenesisState updates the bank genesis state with custom genesis state
func setBankGenesisState(qieApp *app.Qie, genesisState qietypes.GenesisState, customGenesis interface{}) (qietypes.GenesisState, error) {
	...
	qieApp.AppCodec().MustUnmarshalJSON(genesisState[banktypes.ModuleName], bankGen)
	...
	genesisState[banktypes.ModuleName] = qieApp.AppCodec().MustMarshalJSON(bankGen)
	return genesisState, nil
}
...
func setDefaultAuthGenesisState(qieApp *app.Qie, genesisState qietypes.GenesisState, genAccs []authtypes.GenesisAccount) qietypes.GenesisState {
	defaultAuthGen := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccs)
	genesisState[authtypes.ModuleName] = qieApp.AppCodec().MustMarshalJSON(defaultAuthGen)
	return genesisState
}

// setAuthGenesisState updates the bank genesis state with custom genesis state
func setAuthGenesisState(qieApp *app.Qie, genesisState qietypes.GenesisState, customGenesis interface{}) (qietypes.GenesisState, error) {
	...
	qieApp.AppCodec().MustUnmarshalJSON(genesisState[authtypes.ModuleName], authGen)
	...
	genesisState[authtypes.ModuleName] = qieApp.AppCodec().MustMarshalJSON(authGen)
	return genesisState, nil
}
...
func setDefaultGovGenesisState(qieApp *app.Qie, genesisState qietypes.GenesisState, overwriteParams GovCustomGenesisState) qietypes.GenesisState {
	...
	genesisState[govtypes.ModuleName] = qieApp.AppCodec().MustMarshalJSON(govGen)
	return genesisState
}

func setDefaultErc20GenesisState(qieApp *app.Qie, genesisState qietypes.GenesisState) qietypes.GenesisState {
	erc20Gen := erc20types.DefaultGenesisState()
	genesisState[erc20types.ModuleName] = qieApp.AppCodec().MustMarshalJSON(erc20Gen)
	return genesisState
}

// defaultAuthGenesisState sets the default genesis state
// for the testing setup
func newDefaultGenesisState(qieApp *app.Qie, params defaultGenesisParams) qietypes.GenesisState {
	genesisState := qieApp.DefaultGenesis()

	genesisState = setDefaultAuthGenesisState(qieApp, genesisState, params.genAccounts)
	genesisState = setDefaultStakingGenesisState(qieApp, genesisState, params.staking)
	genesisState = setDefaultBankGenesisState(qieApp, genesisState, params.bank)
	genesisState = setDefaultGovGenesisState(qieApp, genesisState, params.gov)
	genesisState = setDefaultSlashingGenesisState(qieApp, genesisState, params.slashing)
	genesisState = setDefaultErc20GenesisState(qieApp, genesisState)
...
func customizeGenesis(qieApp *app.Qie, customGen CustomGenesisState, genesisState qietypes.GenesisState) (qietypes.GenesisState, error) {
	var err error
	for mod, modGenState := range customGen {
		if fn, found := genesisSetupFunctions[mod]; found {
			genesisState, err = fn(qieApp, genesisState, modGenState)
			if err != nil {
